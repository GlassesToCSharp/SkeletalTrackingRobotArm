...
namespace KinectSkeletalTracking
{
    public class ForwardKinematics : IEquatable<ForwardKinematics>
    {
        ...
        public static ForwardKinematics GetForwardKinematicsRight(Point3 shoulderPosition, InverseKinematics ik)
        {
            ...
            return GetForwardKinematicsRight(shoulderPosition, inRadians.ShoulderYaw, inRadians.ShoulderPitch, inRadians.ShoulderRoll, inRadians.ElbowPitch, inRadians.UpperArmLength, inRadians.LowerArmLength);
        }

        public static ForwardKinematics GetForwardKinematicsLeft(Point3 shoulderPosition, InverseKinematics ik)
        {
            // The angles are required to be in radians. Just in case they are not, convert to radians.
            InverseKinematics inRadians = ik.ToRadians();
        ...
        /// <summary>
        /// Retrieves the forward kinematics for the right arm. All positions and angles should correspond to the right arm.
        /// </summary>
        /// <param name="shoulderPosition">The position of the right shoulder.</param>
        ...
        /// <returns>A <c>ForwardKinematics</c> instance with the necessary <c>Point3</c>s.</returns>
        public static ForwardKinematics GetForwardKinematicsRight(Point3 shoulderPosition, double shoulderYawRadians, double shoulderPitchRadians, double shoulderRollRadians, double elbowPitchRadians, double upperArmLength, double lowerArmLength)
        {
        ...
        /// <summary>
        /// Retrieves the forward kinematics for the left arm. All positions and angles should correspond to the right arm.
        /// </summary>
        /// <param name="shoulderPosition">The position of the left shoulder.</param>
        /// <param name="shoulderYawRadians">The angle of the shoulder yaw in radians.</param>
        /// <param name="shoulderPitchRadians">The angle of the shoulder pitch in radians.</param>
        /// <param name="shoulderRollRadians">The angle of the shoulder roll in radians.</param>
        /// <param name="elbowPitchRadians">The angle of the elbow pitch in radians</param>
        ...
        /// <param name="lowerArmLength">The length of the lower arm.</param>
        /// <returns>A <c>ForwardKinematics</c> instance with the necessary <c>Point3</c>s.</returns>
        public static ForwardKinematics GetForwardKinematicsLeft(Point3 shoulderPosition, double shoulderYawRadians, double shoulderPitchRadians, double shoulderRollRadians, double elbowPitchRadians, double upperArmLength, double lowerArmLength)
        {
            Matrix elbowMatrix = GetElbowTranslationMatrixLeft(shoulderPosition, upperArmLength, shoulderYawRadians, shoulderPitchRadians);
            Point3 elbow = GetElbowPointLeft(shoulderPosition, upperArmLength, shoulderYawRadians, shoulderPitchRadians, elbowMatrix: elbowMatrix);
            Point3 wrist = GetWristPointLeft(elbowMatrix, shoulderRollRadians - shoulderYawRadians, elbowPitchRadians, lowerArmLength);

            return new ForwardKinematics(shoulderPosition, elbow, wrist);
        }

        /// <summary>
        /// Gets the point of the right elbow from the right shoulder position, given the angles and arm length.
        /// </summary>
        ...
        public static Point3 GetElbowPointRight(Point3 shoulderPosition, double upperArmLength, double shoulderYawRadians, double shoulderPitchRadians, Matrix elbowMatrix = null)
        {
            Matrix matrix = elbowMatrix ?? GetElbowTranslationMatrixRight(shoulderPosition, upperArmLength, shoulderYawRadians, shoulderPitchRadians);
            return GetPositionPointFromMatrix(matrix);
        }

        /// <summary>
        /// Gets the point of the left elbow from the left shoulder position, given the angles and arm length.
        /// </summary>
        /// <param name="shoulderPosition">The point to the shoulder associated to the arm.</param>
        /// <param name="upperArmLength">The length of the upper arm.</param>
        /// <param name="shoulderYawRadians">The angle of the shoulder yaw in radians.</param>
        ...
        /// <param name="elbowMatrix">[Optional] The forward kinematic matrix to get to the elbow position.</param>
        /// <returns>The point of the elbow from the shoulder.</returns>
        public static Point3 GetElbowPointLeft(Point3 shoulderPosition, double upperArmLength, double shoulderYawRadians, double shoulderPitchRadians, Matrix elbowMatrix = null)
        {
            Matrix matrix = elbowMatrix ?? GetElbowTranslationMatrixLeft(shoulderPosition, upperArmLength, shoulderYawRadians, shoulderPitchRadians);
            return GetPositionPointFromMatrix(matrix);
        }


        /// <summary>
        /// Gets the point of the right elbow from the given elbow translation matrix, and the given angles and arm length.
        /// </summary>
        ...
        public static Point3 GetWristPointRight(Matrix elbowTranslationMatrix, double shoulderRollRadians, double elbowPitchRadians, double lowerArmLength)
        {
        ...
        /// <param name="lowerArmLength">The length of the lower arm.</param>
        /// <returns>The point of the wrist from the origin of the elbow translation matrix.</returns>
        public static Point3 GetWristPointLeft(Matrix elbowTranslationMatrix, double shoulderRollRadians, double elbowPitchRadians, double lowerArmLength)
        {
            Matrix t03 = elbowTranslationMatrix;
        ...
        /// <summary>
        /// Gets the DH Matrix required to translate from the right shoulder joint to the right elbow joint.
        /// </summary>
        /// <param name="shoulderPosition">The point to the shoulder associated to the arm.</param>
        /// <param name="upperArmLength">The length of the upper arm.</param>
        /// <param name="shoulderYawRadians">The angle of the shoulder yaw in radians.</param>
        ...
        public static Matrix GetElbowTranslationMatrixRight(Point3 shoulderPosition, double upperArmLength, double shoulderYawRadians, double shoulderPitchRadians)
        {
        ...
        /// <summary>
        /// Gets the DH Matrix required to translate from the left shoulder joint to the left elbow joint.
        /// </summary>
        /// <param name="shoulderPosition">The point to the shoulder associated to the arm.</param>
        /// <param name="upperArmLength">The length of the upper arm.</param>
        /// <param name="shoulderYawRadians">The angle of the shoulder yaw in radians.</param>
        /// <param name="shoulderPitchRadians">The angle of the shoulder pitch in radians.</param>
        /// <returns>The translation matrix from base to elbow.</returns>
        public static Matrix GetElbowTranslationMatrixLeft(Point3 shoulderPosition, double upperArmLength, double shoulderYawRadians, double shoulderPitchRadians)
        {
            // Base - right shoulder point.
            // T01 - Translation from base to shoulder yaw (revolution about X axis)
            // T12 - Translation from shoulder yaw to shoulder pitch (revolution about Z axis)
